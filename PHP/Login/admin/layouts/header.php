...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="./../Principal/index.php" class="nav-link">Home</a>
      </li>
    </ul>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
        <i style="color: white; padding:10px 0" class="fas fa-user-lock"></i>
        </div>
        <div class="info">
        <a href="#" class="d-block"><?php echo $_SESSION['session_admin']; ?></a>
        </div>
    </div>
    ...
    <nav class="mt-2">
        ...
        <li class="nav-item">
            <a href="./../Usuario/usuarios.php" class="nav-link">
