...
<head>
    ...
    ?>
    <!-- Personal -->
    <link rel="stylesheet" href="../CSS/venta2.css">
    <title>Venta</title>
</head>
            ...
            <div class="formulario">
                <form action="gracias.php" method="POST">
                    ...
                    ?>
                        ...
                        <!-- <h1 class="titulo">Lugar de Destino</h1>
                        <hr>
                        <div>
                ...
                <div>
                    ...
                    ?>
                        <div class="lisproducts_div">
                            ...
                            <h3>Precio subtotal: <?php echo "$" . number_format($arreglo[$i]['Precio'] * $arreglo[$i]['Cantidad'], 2, '.', ',') ?></h3>
                        </div>
                    <?php
                    }
                    ?>
